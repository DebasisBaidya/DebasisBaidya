  ...
  <tr>
    <td align="left" style="padding: 0 20px; max-width: 400px;">
      <ul>
        ...
        <li>🩺 <a href="https://github.com/DebasisBaidya/Custom-OCR-with-YOLO-on-Drive_Project-10.git">Custom Object Character Recognition (OCR) on AWS/Google Drive</a></li>
